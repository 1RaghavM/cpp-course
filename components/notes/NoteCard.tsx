...
export function NoteCard({
  ...
  return (
    <Link
      href={`/dashboard/notes/${lessonSlug}`}
    ...
    >
      <span className="mt-0.5 inline-flex h-6 w-6 shrink-0 items-center justify-center rounded bg-primary/10 text-[10px] font-bold text-foreground">
        {lessonNumber}
      </span>
      <div className="min-w-0 flex-1">
        <p className="text-sm font-medium text-foreground group-hover:text-sidebar-primary transition-colors truncate">
          {lessonTitle}
        </p>
        {snippet && (
