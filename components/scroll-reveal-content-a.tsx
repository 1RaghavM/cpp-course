...
const imageClass =
  "absolute top-1/2 -translate-y-1/2 right-0 ml-auto w-full h-[55vh] object-cover rounded-2xl transition-opacity duration-300"
    ...
    <div className={cn("bg-background", className)} ref={ref0} {...props}>
      <div className="max-w-[90vw] mx-auto">
        <div className="flex w-full mx-auto relative z-20">
          ...
          >
            <div className="flex flex-row gap-8 md:gap-12 lg:gap-16 xl:gap-20 2xl:gap-24 w-full h-full">
              <div className="lg:!w-[40vw] !w-full h-auto flex flex-col justify-center gap-10 md:gap-auto">
                <PointItem
                  active={true}
                  number="01"
              ...
              <div className="hidden lg:flex flex-col justify-center items-center !w-[60vw] relative h-full">
                <Image
